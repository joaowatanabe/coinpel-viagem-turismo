        ...
        <div id="sidebar-backdrop" onclick="toggleSidebar()" class="fixed inset-0 z-20 bg-black/50 hidden lg:hidden"></div>        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 flex flex-col w-[280px] bg-coinpel-primary text-white shadow-xl transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out shrink-0">
            <div class="flex items-center justify-center h-20 border-b border-white/10 shrink-0">
                <a href="{{ route('dashboard') }}" class="hover:opacity-95 transition-opacity">
                    <img src="{{ asset('logo-coinpel-dashboard.png') }}" alt="COINPEL" class="h-6 w-auto">
                </a>
            </div>

            <nav class="flex-1 px-5 py-6 space-y-2 overflow-y-auto">
                <a href="{{ route('dashboard') }}" 
                   class="relative flex flex-row items-center gap-3.5 px-4 py-3 rounded-xl transition duration-150 ease-in-out {{ request()->routeIs('dashboard') ? 'bg-[#4B3165] text-white font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                    @if(request()->routeIs('dashboard'))
                        <div class="absolute left-0 top-3 bottom-3 w-1 bg-white rounded-r"></div>
                    @endif
                    <svg class="w-5.5 h-5.5 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"></path>
                    </svg>
                    <span class="text-sm font-medium tracking-wide">Painel</span>
                </a>

                <a href="{{ route('trips.index') }}" 
                   class="relative flex flex-row items-center gap-3.5 px-4 py-3 rounded-xl transition duration-150 ease-in-out {{ request()->routeIs('trips.*') ? 'bg-[#4B3165] text-white font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                    ...
                    <svg class="w-5.5 h-5.5 shrink-0" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M21 1H11C9.67441 1.00159 8.40356 1.52888 7.46622 2.46622C6.52888 3.40356 6.00159 4.67441 6 6V20C6.00053 20.5303 6.21141 21.0387 6.58637 21.4136C6.96133 21.7886 7.46973 21.9995 8 22V25H10V22H22V25H24V22C24.5302 21.9992 25.0384 21.7882 25.4133 21.4133C25.7882 21.0384 25.9992 20.5302 26 20V6C25.9984 4.67441 25.4711 3.40356 24.5338 2.46622C23.5964 1.52888 22.3256 1.00159 21 1ZM24 7V13H8V7H24ZM11 3H21C21.6184 3.00184 22.2211 3.19507 22.7253 3.55318C23.2296 3.91128 23.6105 4.41669 23.816 5H8.184C8.38945 4.41669 8.77045 3.91128 9.27465 3.55318C9.77886 3.19507 10.3816 3.00184 11 3ZM8 20V15H24.001L24.002 20H8Z" fill="currentColor"/>
                ...
                <a href="{{ route('vehicles.index') }}" 
                   class="relative flex flex-row items-center gap-3.5 px-4 py-3 rounded-xl transition duration-150 ease-in-out {{ request()->routeIs('vehicles.*') ? 'bg-[#4B3165] text-white font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                ...
                <a href="{{ route('drivers.index') }}" 
                   class="relative flex flex-row items-center gap-3.5 px-4 py-3 rounded-xl transition duration-150 ease-in-out {{ request()->routeIs('drivers.*') ? 'bg-[#4B3165] text-white font-semibold' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
                ...
                <a href="#" 
                   class="relative flex flex-row items-center gap-3.5 px-4 py-3 rounded-xl transition duration-150 ease-in-out text-white/70 hover:bg-white/5 hover:text-white">
                    <svg class="w-5.5 h-5.5 shrink-0" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
