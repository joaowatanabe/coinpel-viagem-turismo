                ...
                @foreach($drivers as $driver)
                    <div class="relative p-5 bg-white border border-gray-100 hover:border-coinpel-primary/20 hover:shadow-md rounded-2xl flex flex-col justify-between transition group">
                        ...
                        <div class="absolute top-4 right-4 driver-actions-wrapper">
                            ...
                            <div class="driver-actions-menu hidden absolute right-0 mt-1.5 w-36 bg-white border border-gray-100 rounded-xl shadow-lg py-1.5 z-10">
                                <button type="button"
                                        class="btn-edit-driver w-full text-left px-4 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 transition cursor-pointer"
                                        data-id="{{ $driver->id }}"
                                ...
                                <button type="button"
                                        class="btn-delete-driver w-full text-left px-4 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 transition cursor-pointer"
                                        data-id="{{ $driver->id }}"
                                        data-name="{{ $driver->name }}">
                                    Excluir motorista
                                </button>
